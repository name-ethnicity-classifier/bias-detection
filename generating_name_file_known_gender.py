...
gender_name_to_ethnicity_file = "/Users/franziskahafner/Desktop/paper/testing_AI/input/names_to_ethnicity_known_gender_14else.csv"
...
with open ("/Users/franziskahafner/Desktop/paper/testing_AI/input/persons-with-significant-control-snapshot-2020-05-30.txt", "r") as f:
    for line in f.readlines():
        ...
        try:
            ...
            if contains_foreign_letters == False:
                try:
...
with open(gender_name_to_ethnicity_file, "w") as f:
    f.write("names, gender, nationality\n")
